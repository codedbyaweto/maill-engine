  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        yellow:
            "bg-yellow-400 text-black dark:bg-[#00004f] dark:text-white shadow-sm hover:bg-yellow-500 active:bg-yellow-600",
        moon:
            "bg-[#2b251a] text-white dark:bg-blue-400 dark:text-black shadow-sm hover:bg-[#3a3224] active:bg-[#2b251a]",
        earth:
            "bg-[#2b251a] text-white dark:bg-[#00004f] dark:text-white shadow-sm hover:bg-[#3a3224] active:bg-[#2b251a]",
        destructive:
